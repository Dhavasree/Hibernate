...
public class CopyData
{
  ...
  public static void main(String[] args)
  {
    ...
    copyData.overrideColumnMatch(true);
  ...
  private boolean init()
  {
    ...
    try
    {
      FileInputStream inputStream = new FileInputStream("./datapump_config.xml");//read xml file 
      dataPump = (DataPump)xstream.fromXML(inputStream);//convert xml to object
    }
    catch (Exception e)
    {
  ...
  private void fetchMetaData(java.sql.Connection con, String schema, String table, boolean flag)
  {
    try
    {
      DatabaseMetaData md = con.getMetaData();//used to get information of properties like name,type and number of column
