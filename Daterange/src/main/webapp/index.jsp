...
<script>
	$(function() {
		...
		$("#datetimepicker2").daterangepicker({
		 ...
		 $("#datetimepicker2").on('hideCalendar.daterangepicker', function(ev, picker) {
		      $(this).val('');
		  }); 
	});
...
<body>
   <form id="date" action="value">
		...
		End Date: <br> <input type="text" id="datetimepicker2" name="datetimepicker2" class="field left" readonly ><br>
